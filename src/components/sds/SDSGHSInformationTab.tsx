...
import { SDSPrecautionaryStatementsSection } from "./SDSPrecautionaryStatementsSection";
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-6">
        <h3 className="text-lg font-semibold">GHS Classifications</h3>
      ...
      <SDSPrecautionaryStatementsSection sds={sds} readOnly={readOnly} />
    </div>
  );
}
