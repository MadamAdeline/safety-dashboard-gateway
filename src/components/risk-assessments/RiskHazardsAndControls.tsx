  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between mb-4">
        <h2 className="text-xl font-semibold">Hazards and Controls</h2>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50">
              ...
              <TableHead className="w-[100px] text-right">Risk Level</TableHead>
          ...
          <TableBody>
            {hazards.map((hazard) => (
              <Collapsible key={hazard.id} open={openItems.includes(hazard.id)}>
                ...
                <CollapsibleContent>
                  <TableRow>
                    <TableCell colSpan={6} className="p-6 bg-gray-50 border-t">
